        ...
        <div className="public-page min-h-screen flex bg-slate-50">
            ...
            >
                ...
                <div className="relative z-10">
                    <Link to="/" className="inline-flex items-center gap-2.5 group">
                        {logoSrc ? (
                            <img src={logoSrc} alt={platformName} className="w-10 h-10 object-contain rounded-xl" />
                        ) : (
                            <div
                ...
                <div className="relative z-10 space-y-8">
                    ...
                    {/* Mini stats — database-backed */}
                    {stats && (stats.totalSchools > 0 || stats.totalStudents > 0) && (
                        <div className="grid grid-cols-2 gap-3 pt-2 animate-in fade-in duration-500">
                            {[
                                [`${stats.totalSchools || 0}`, 'Schools Managed'],
                                [`${stats.totalStudents || 0}`, 'Students Enrolled'],
                                [`${stats.totalBranches || 0}`, 'Branches Active'],
                                [`${stats.activePlans || 0}`, 'Subscription Tiers']
                            ].map(([v, l]) => (
            ...
            <div className="flex-1 flex flex-col items-center justify-center px-6 py-12">
                ...
                <div className="lg:hidden mb-8 flex items-center gap-2.5">
                    {logoSrc ? (
                        <img src={logoSrc} alt={platformName} className="w-9 h-9 object-contain rounded-xl" />
                    ) : (
                ...
                <div className="w-full max-w-[420px]">
                    ...
                    <p className="text-center text-[0.78rem] text-slate-400 font-medium mt-5">
                        Your data is protected · {platformName}
                    </p>
                </div>
            </div>
        </div>
